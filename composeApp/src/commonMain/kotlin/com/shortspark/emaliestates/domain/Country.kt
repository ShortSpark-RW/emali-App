...
val Countries = listOf(Country("Afghanistan", "AF", "+93", "🇦🇫"),
    ...
    Country("Saint Kitts and Nevis", "KN", "+1-869", "🇰🇳"),
    Country("Saint Lucia", "LC", "+1-758", "🇱🇨"),
    Country("Saint Vincent and the Grenadines", "VC", "+1-784", "🇻🇨"),
...
data class Country(
    val name: String,
    val iso: String,      // e.g. "RW"
    val dialCode: String, // e.g. "+250"
